...
export default function BuyerFloatingActions() {
  ...
  return (
    <aside
      className="buyer-floating-actions d-lg-none lg:hidden fixed z-40 transition-all duration-300 flex flex-col items-end gap-2.5 pointer-events-auto select-none"
      style={{
        /* Positioned above mobile bottom bar (60px) on mobile view, removed in desktop mode (>= 992px) */
