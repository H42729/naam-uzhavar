...
export default function BuyerNavbar({
  ...
  return (
    <>
      <header className="bd-navbar sticky-top">
        ...
        <div className="d-flex align-items-center gap-1.5 gap-sm-2 gap-md-3">
          ...
          >
            ...
            />
            <span className="badge bg-primary-subtle text-primary border border-primary-subtle rounded-pill px-2 py-1 small fw-bold d-none d-sm-inline-block">
              {t('buyerPortal')}
            </span>
          </div>
        </div>

        {/* Right: Language Switcher, Notifications, Profile, and Logout */}
        <div className="bd-nav-right d-flex align-items-center gap-1 gap-sm-2">
          ...
          <div className="position-relative">
            ...
            {showNotifications && (
              <div
                ...
                style={{ width: '330px', maxWidth: 'calc(100vw - 32px)', zIndex: 1050 }}
              >
                <div className="d-flex justify-content-between align-items-center pb-2 border-bottom mb-2">
                  <div className="d-flex align-items-center gap-2">
                    <span className="fw-bold text-dark small">🔔 {t('notifications')}</span>
      ...
      {/* Profile Detail Modal - Portalized for guaranteed center alignment */}
      {showProfileModal &&
        createPortal(
